function action() {
    new Vue({
        ...
        data: {
            ...
            getListUrl: 'headofficecheck/rzManagerDeptList.xa',//列表接口
            upDownUrl: 'headofficecheck/rzExportResult.xa',//导出接口
        ...
        methods: {
            ...
            toDetail(departmentname){
                window.location.href = './depDetail.html?departmentname=' + encodeURI(departmentname) + '&month=' + this.searchYearMonth;
            },

function action() {
    new Vue({
        ...
        data: {
            ...
            getListUrl: 'qykhCentralizedJob/getQykhCentralizedJobList.xa',//列表接口
        ...
        methods: {
            ...
            getList(){
                ...
                if(_this.active == 1){
                    ...
                    params.approvalStatus = '';
                    params.date = '';
                    params.orgName = _this.searchName;
                }
                ...
                $http(_this.getListUrl,true,params, true)
                    .then(res => {
                        if(res.retcode == 'success'){
                            ...
                            if(res.data.qykhApprovalRecordPageInfo.list){
                                var arr = res.data.qykhApprovalRecordPageInfo.list;
                                if(arr.length == 0){
                                    if(_this.pagenum == 1){
            ...
            //--------------------------------------------------------------------- 跳转
            toDetail(appNo){
                window.location.href = './detail.html?appNo=' + appNo;
            },

var baseUrl = {
    queryList: "retailsalescheck/getRectificationProblemList.xa",
}
var vm
function initFun () {
    vm = new Vue({
        ...
        methods:{
            ...
            jump(item){
                if(this.tab=='11'){
                    window.location.href = 'rectify.html?id='+item.id
                }else if(this.tab=='22'){
                    window.location.href = 'rectifyClose.html?id='+item.id
                }else{
                    window.location.href = 'rectifyDetail.html?id='+item.id
                }

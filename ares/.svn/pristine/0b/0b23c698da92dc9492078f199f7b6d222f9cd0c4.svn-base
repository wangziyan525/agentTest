function action() {
    new Vue({
        ...
        data: {
            ...
            getListUrl: '/bail/xd/queryUnApprovedInfo.xa',//列表接口
        ...
        methods: {
            ...
            getList(){
                let _this = this;
                let params = {};
                params.AudSt = _this.active;
                params.CurrPg = _this.pagenum + '';
                params.PgSz = '10';
                params.CoNm = _this.searchName;
                if(_this.active == 0){
                    params.AprvSt = '';
                    params.AudSt = 'N';
                    params.StrtTm = '';
                    ...
                    params.StrtTm = _this.startTime;
                    params.EndTm = _this.endTime;
                    params.AudSt = 'Y';
                    if(_this.filterStatusText == '全部审批状态'){
                        ...
                        params.AprvSt = '2';
                    }else if(_this.filterStatusText == '退回再议'){
                        params.AprvSt = '3';
                    }
                };
            ...
            //--------------------------------------------------------------------- 跳转
            toDetail(no){
                window.location.href = './applyDetail.html?batchNo=' + no;
            },

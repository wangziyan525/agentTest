                        ...
                        if(res.retcode == 'success'){
                            ...
                            if(list.length>0){
                                for(var i=0;i<list.length;i++){
                                    that.popupObject4.columns.push({text: list[i].specialCheckName, val: list[i].id})
                                }
                            }
                    ...
                    .then(res => {
                        if(res.retcode == 'success'){
                            ...
                            for(var j=0;j<that.orgList.length;j++){
                                if(that.orgList[j].orgname == that.submitInfo.checkFirstOrgName)

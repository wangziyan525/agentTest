var baseUrl = {
    ...
    problemApproveSubmit:'retailsalescheck/problemApproveSubmit.xa',
}
function initFun() {
    new Vue({
        el: "#app",
        ...
        methods: {
            ...
            submitBindtap() {
                ...
                vant.Dialog.confirm({
                    ...
                    $http(baseUrl.problemApproveSubmit,true,params, true)
                        .then(res => {
                            if(res.retcode == 'success'){
                                $.alert("","提交成功",function () {
                                    window.location.href = 'rectifyApproveList.html';
                                });

var baseUrl = {
    ...
    queryTotalUrl:'phjdData/phjdStatisticTotal.xa',//查看建档有效建档统计
    queryListUrl1:'phjdData/phjdStatisticBudescr.xa',//查看建档管理行数据统计
    queryListUrl2:'phjdData/phjdStatisticSsbm.xa',//查看建档经营行数据统计
    queryListUrl3:'phjdData/phjdStatisticEmployee.xa',//查看建档员工数据统计

    downLoadUrl:'phjdData/phjdStatisticCustomerExport.xa',////建档客户明细数据下载
    downExportUrl1:'phjdData/phjdStatisticBudescrExport.xa',////建档一级机构排行榜数据下载
    downExportUrl2:'phjdData/phjdStatisticSsbmExport.xa',////建档经营支行排行榜数据下载
    downExportUrl3:'phjdData/phjdStatisticEmployeeExport.xa',////建档员工排行榜数据下载
...
function initFun () {
    vm = new Vue({
        ...
        methods:{
            ...
            toPage(param){
                window.location.href="index.html?datatype=1";
            ...
            warnText(){
                vant.Dialog.alert({
                    message: "信息字段完整，自主申报后，经过抽查人认定后的建档。"
                }).then(() => {
            ...
            async queryData(){
                ...
                if (res.retcode === 'success'){
                    ...
                    that.waitdeclared=res.data.waitdeclared;
                    that.declared=res.data.declared;
